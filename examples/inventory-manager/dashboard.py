...
class IMS:
    def __init__(self, root):
        ...
        # Title
        self.icon_title = PhotoImage(file=os.path.join(HERE, "checklist .png"))  # patched: HERE replaces hardcoded author path
        ...
        # Left Menu
        self.MenuLogo = Image.open(os.path.join(HERE, "images", "menu_im.png"))  # patched: HERE replaces hardcoded author path
        ...
        self.icon_side = PhotoImage(file=os.path.join(HERE, "images", "side.png"))  # patched: HERE replaces hardcoded author path
    ...
    def update_content(self):
        ...
        try:
            ...
            bill_path = os.path.join(HERE, "bill")  # [patched]
