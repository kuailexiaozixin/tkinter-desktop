...
> 来源：https://mhammond.github.io/pywin32/win32wnet.html （及其成员页，已全部内联）
...
# win32wnet 成员详细文档（共 14 项）


---

<!-- page: win32wnet__NCBBuffer_meth.html -->
...
<!-- page: win32wnet__Netbios_meth.html -->
...
<!-- page: win32wnet__WNetAddConnection2_meth.html -->
...
#### Comments
 ...
 This function also accepts backwards-compatible, positional-only arguments of (dwType, lpLocalName, lpRemoteName[, lpProviderName, Username, Password, flags])

 Accepts keyword arguments.

#### Win32 API References

- Search for WNetAddConnection2 at [msdn](https://learn.microsoft.com/en-ca/search/?terms=WNetAddConnection2), [google](https://www.google.com/search?q=WNetAddConnection2) or [google groups](https://groups.google.com/groups?q=WNetAddConnection2).


---

<!-- page: win32wnet__WNetAddConnection3_meth.html -->
...
- Search for WNetAddConnection3 at [msdn](https://learn.microsoft.com/en-ca/search/?terms=WNetAddConnection3), [google](https://www.google.com/search?q=WNetAddConnection3) or [google groups](https://groups.google.com/groups?q=WNetAddConnection3).


---

<!-- page: win32wnet__WNetCancelConnection2_meth.html -->
...
<!-- page: win32wnet__WNetCloseEnum_meth.html -->
...
- handle : PyHANDLE
 ...
 The handle to close, as obtained from win32wnet::WNetOpenEnum

#### Comments

 You should perform a WNetClose for each handle returned from win32wnet::WNetOpenEnum.


---

<!-- page: win32wnet__WNetEnumResource_meth.html -->
...
<!-- page: win32wnet__WNetGetConnection_meth.html -->
...
- connection=None : string
 ...
 A string that is a drive-based path for a network resource. For example, if drive H has been mapped to a network drive share, and the network resource of interest is a file named Sample.doc in the directory \\Win32\\Examples on that share, the drive-based path is H:\\Win32\\Examples\\Sample.doc.


---

<!-- page: win32wnet__WNetGetLastError_meth.html -->
...
<!-- page: win32wnet__WNetGetResourceInformation_meth.html -->

## win32wnet.WNetGetResourceInformation

 (PyNETRESOURCE, str) = WNetGetResourceInformation(NetResource)
...
<!-- page: win32wnet__WNetGetResourceParent_meth.html -->

## win32wnet.WNetGetResourceParent

 PyNETRESOURCE = WNetGetResourceParent(NetResource)
...
<!-- page: win32wnet__WNetGetUniversalName_meth.html -->
...
<!-- page: win32wnet__WNetGetUser_meth.html -->
