...
> 来源：https://github.com/mhammond/pywin32/blob/main/com/help/active_directory.html
...
- The time property
- a href="#users">Managing Users(to be added)
...
- Convert Active Directory time to python time Later we'll add information about managing users and computers.
...
#### Discovery
 ...
 A tool that can be of a great help is the ADSI Edit MMC snap-in, aka ADSIEdit.msc. See [Remote Server Administration Tools for Windows 10](https://www.microsoft.com/en-us/download/details.aspx?id=45520) for installation instructions. It gives you the raw ldap view of active directory. Note that it is not available for the Home edition of Windows.
...
- [Windows Active Directory documentation](https://learn.microsoft.com/en-us/troubleshoot/windows-server/active-directory/active-directory-overview)
