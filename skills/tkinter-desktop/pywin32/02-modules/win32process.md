...
> 来源：https://mhammond.github.io/pywin32/win32process.html （及其成员页，已全部内联）
...
# win32process 成员详细文档（共 50 项）


---

<!-- page: win32process__AttachThreadInput_meth.html -->
...
<!-- page: win32process__CreateProcessAsUser_meth.html -->
...
<!-- page: win32process__CreateProcess_meth.html -->
...
| | DEBUG_PROCESS | If this flag is set, the calling process is treated as a debugger, and the new process is debugged. The system notifies the debugger of all debug events that occur in the process being debugged. If you create a process with this flag set, only the calling thread (the thread that called CreateProcess) can call the WaitForDebugEvent function.
...
| | BELOW_NORMAL_PRIORITY_CLASS | Indicates a process that has priority higher than IDLE_PRIORITY_CLASS but lower than NORMAL_PRIORITY_CLASS.
...
<!-- page: win32process__CreateRemoteThread_meth.html -->
...
<!-- page: win32process__EnumProcessModulesEx_meth.html -->
...
<!-- page: win32process__EnumProcessModules_meth.html -->
...
<!-- page: win32process__EnumProcesses_meth.html -->
...
<!-- page: win32process__ExitProcess_meth.html -->
...
<!-- page: win32process__GetCurrentProcessId_meth.html -->
...
<!-- page: win32process__GetCurrentProcess_meth.html -->
...
<!-- page: win32process__GetExitCodeProcess_meth.html -->
...
<!-- page: win32process__GetExitCodeThread_meth.html -->
...
<!-- page: win32process__GetGuiResources_meth.html -->
...
<!-- page: win32process__GetModuleFileNameEx_meth.html -->
...
<!-- page: win32process__GetPriorityClass_meth.html -->
...
<!-- page: win32process__GetProcessAffinityMask_meth.html -->
...
<!-- page: win32process__GetProcessId_meth.html -->
...
<!-- page: win32process__GetProcessIoCounters_meth.html -->
...
<!-- page: win32process__GetProcessMemoryInfo_meth.html -->
...
<!-- page: win32process__GetProcessPriorityBoost_meth.html -->
...
<!-- page: win32process__GetProcessShutdownParameters_meth.html -->
...
<!-- page: win32process__GetProcessTimes_meth.html -->
...
<!-- page: win32process__GetProcessVersion_meth.html -->
...
<!-- page: win32process__GetProcessWindowStation_meth.html -->
...
<!-- page: win32process__GetProcessWorkingSetSize_meth.html -->
...
<!-- page: win32process__GetStartupInfo_meth.html -->
...
<!-- page: win32process__GetThreadIOPendingFlag_meth.html -->
...
<!-- page: win32process__GetThreadPriorityBoost_meth.html -->
...
<!-- page: win32process__GetThreadPriority_meth.html -->
...
<!-- page: win32process__GetThreadTimes_meth.html -->
...
<!-- page: win32process__GetWindowThreadProcessId_meth.html -->
...
<!-- page: win32process__IsWow64Process_meth.html -->
...
- Process=None : PyHANDLE
 ...
 Handle to a process as returned by win32api::OpenProcess, win32api::GetCurrentProcess, etc, or will use the current process handle if None (the default) is passed.
...
<!-- page: win32process__ReadProcessMemory_meth.html -->

## win32process.ReadProcessMemory

 bytes = ReadProcessMemory(hProcess, address , size )
...
<!-- page: win32process__ResumeThread_meth.html -->
...
<!-- page: win32process__STARTUPINFO_meth.html -->
...
<!-- page: win32process__SetPriorityClass_meth.html -->
...
<!-- page: win32process__SetProcessAffinityMask_meth.html -->
...
<!-- page: win32process__SetProcessPriorityBoost_meth.html -->
...
<!-- page: win32process__SetProcessShutdownParameters_meth.html -->
...
<!-- page: win32process__SetProcessWorkingSetSize_meth.html -->
...
<!-- page: win32process__SetThreadAffinityMask_meth.html -->
...
<!-- page: win32process__SetThreadIdealProcessor_meth.html -->
...
<!-- page: win32process__SetThreadPriorityBoost_meth.html -->
...
<!-- page: win32process__SetThreadPriority_meth.html -->
...
<!-- page: win32process__SuspendThread_meth.html -->
...
<!-- page: win32process__TerminateProcess_meth.html -->
...
<!-- page: win32process__VirtualAllocEx_meth.html -->

## win32process.VirtualAllocEx

 long = VirtualAllocEx(hProcess, address , size , allocationType , flProtect )
...
<!-- page: win32process__VirtualFreeEx_meth.html -->

## win32process.VirtualFreeEx

 VirtualFreeEx(hProcess, address, size, freeType)
...
<!-- page: win32process__WriteProcessMemory_meth.html -->

## win32process.WriteProcessMemory

 int = WriteProcessMemory(hProcess, address , buf )
...
<!-- page: win32process__beginthreadex_meth.html -->
