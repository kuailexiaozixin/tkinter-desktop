...
Instead, portable scripts must use the
**[file split](file.md)**
 and
**file
join**
 commands to manipulate file names (see the
**[file](file.md)**
 manual
...
**\\Host\share/file**
Absolute UNC path to a file called **[file](file.md)** in the root directory of
the export point **share** on the host **Host**.  Note that
repeated use of **[file dirname](file.md)** on this path will give
...
*csh*
-style tilde substitution.  If a file name starts with a tilde,
...
Another Windows peculiarity is that any number of trailing dots “.” in filenames are totally ignored, so, for example, attempts to create a file or directory with a name “foo.” will result in the creation of a file/directory with name “foo”. This fact is reflected in the results of **[file normalize](file.md)**. Furthermore, a file name consisting only of dots “.........” or dots with trailing characters “.....abc” is illegal.
