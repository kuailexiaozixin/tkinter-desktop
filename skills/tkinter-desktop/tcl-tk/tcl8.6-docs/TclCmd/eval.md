...
**Eval**
 concatenates all its arguments in the same
fashion as the
**[concat](concat.md)**
 command, passes the concatenated string to the
Tcl interpreter recursively, and returns the result of that
evaluation (or any error generated by it).
Note that the
**[list](list.md)**
 command quotes sequences of words in such a
way that they are not further expanded by the
**eval**
 command.
...
**[lsort](lsort.md)**
 and
**[trace](trace.md)**
 command callbacks). This example shows how
