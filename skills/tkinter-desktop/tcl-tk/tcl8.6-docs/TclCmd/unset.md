...
Each
*name*
 is a variable name, specified in any of the
ways acceptable to the
**[set](set.md)**
 command.
If a
*name*
 refers to an element of an array then that
element is removed without affecting the rest of the array.
If a
*name*
 consists of an array name with no parenthesized
...
If
**-nocomplain**
 is specified as the first argument, any possible
