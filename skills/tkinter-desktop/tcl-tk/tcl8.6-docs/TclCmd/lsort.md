...
*list*
, returning a new
list in sorted order.  The implementation of the
**lsort**
 command
...
element and the *indexList* were passed to **[lindex](lindex.md)**) and sort
...
The options to
**lsort**
 only control what sort of comparison is
