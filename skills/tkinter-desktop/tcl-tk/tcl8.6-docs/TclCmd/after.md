...
arguments in the same fashion as the **[concat](concat.md)** command.
...
registered with **[interp bgerror](interp.md)**.
...
separators (just as in the **[concat](concat.md)** command).
...
separators (just as in the **[concat](concat.md)** command), and arranges
