...
The interpretation of each simple *index* value is the same as for the command **[string index](string.md)**, supporting simple index arithmetic and indices relative to the end of the list.
