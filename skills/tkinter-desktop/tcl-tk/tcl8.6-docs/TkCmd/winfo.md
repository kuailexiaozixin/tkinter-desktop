...
The
**winfo**
 command is used to retrieve information about windows
...
are not returned in stacking order. Use the **[wm stackorder](wm.md)**
...
*width***x***height***+***x***+***y*.  All dimensions are
in pixels.
**winfo height***window*
...
invoke **[update](../TclCmd/update.md)** to force the geometry manager to arrange it,
...
manager, such as **[pack](pack.md)** or **[place](place.md)**.
If the geometry manager is a widget, such as canvases or text, the
name is the widget's class command, such as **[canvas](canvas.md)**.
**winfo name***window*
...
has the form
“**X***major***R***minor vendor vendorVersion*”
...
In standard Tk this will always be a **[toplevel](toplevel.md)** widget, but extensions may
