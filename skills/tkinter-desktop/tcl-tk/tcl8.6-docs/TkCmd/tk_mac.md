...
**::tk::mac::useCompatibilityMetrics**
*boolean*
**::tk::mac::CGAntialiasLimit**
*limit*
**::tk::mac::antialiasedtext**
*number*
**::tk::mac::useThemedToplevel**
*boolean*
**::tk::mac::iconBitmap**
*name width height -kind value*
...
calls to commands in the
**::tk::mac**
 namespace; unless otherwise noted, if
...
or during a logout/restart/shutdown etc. If this is not defined, **[exit](../TclCmd/exit.md)** is
called instead.
**::tk::mac::OnHide**
...
*Credits.rtf* exists in the bundle's Resources directory then its contents
...
Preserves compatibility with older Tk/Aqua metrics; set to **false** for
more native spacing.
...
*number* are -1 (default, use system default for text AA), 0 (no text AA),
1 (use text AA).
...
“**-background systemWindowHeaderBackground**”,
or to using a **[ttk::frame](ttk_frame.md)**.
