...
**[-jump, jump, Jump](options.md#M-jump)**
**[-orient, orient, Orient](options.md#M-orient)**
...
**[-troughcolor, troughColor, Background](options.md#M-troughcolor)**
...
*pathName*
 argument) and makes it into a scrollbar widget.
...
is deprecated.
In the old command syntax, the
**set**
 widget command has the
following form:
