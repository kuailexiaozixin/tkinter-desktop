...
A
*theme*
 is a collection of elements and styles
...
An
*element*
 displays an individual part of a widget.
For example, a vertical scrollbar widget contains
**uparrow**
,
...
- a dynamic setting specified by **[style map](ttk_style.md)** and the current state;
...
A
*layout*
 specifies which elements make up a widget
and how they are arranged.
The layout engine uses a simplified version of the
**[pack](pack.md)**
...
**-side**
 option,
and placed within the parcel according to the
**-sticky**
...
By default, the layout for a widget is the same as its class name. Some widgets may override this (for example, the **[ttk::scrollbar](ttk_scrollbar.md)** widget chooses different layouts based on the **-orient** option).
...
**readonly**
 state
and the various flavors of buttons which have
**active**
 state.
...
For example, the class bindings for the **[ttk::button](ttk_button.md)** widget are:
...
Many elements are displayed differently depending on the widget state. For example, buttons have a different background when they are active, a different foreground when disabled, and a different relief when pressed. The **[style map](ttk_style.md)** command specifies dynamic option settings for a particular style:
