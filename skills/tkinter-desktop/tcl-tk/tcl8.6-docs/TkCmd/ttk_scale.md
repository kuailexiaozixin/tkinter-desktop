...
A
**ttk::scale**
 widget is typically used to control the numeric value of a
linked variable that varies uniformly over some range. A scale displays a

*slider*
 that can be moved along over a
*trough*
, with the relative
...
**TScale** styling options configurable with **[ttk::style](ttk_style.md)** are:

**-background** *color* **-borderwidth** *amount* **-darkcolor** *color* **-groovewidth** *amount* **-lightcolor** *color* **-sliderwidth** *amount* **-troughcolor** *color* **-troughrelief** *relief*
