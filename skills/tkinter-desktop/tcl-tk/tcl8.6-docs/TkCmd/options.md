...
the widget
**.a.b.c**
.  Command-line switches may be abbreviated,
...
The value may have any of the forms described in the **[font](font.md)** manual
page under **[FONT DESCRIPTION](font.md)**.
...
created with the **[image create](image.md)** command.
...
See the section **GRIDDED GEOMETRY MANAGEMENT** in the **[wm](wm.md)** manual
...
Database Name: **[text](text.md)**
Database Class: **[Text](text.md)**
