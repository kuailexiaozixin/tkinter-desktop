...
The
**vsapi**
 element factory creates a new element
...
The
*stateMap*
 parameter is a list of ttk states and the
...
**[ttk::style map](ttk_style.md)**
 command but note that the
...
original header to use was
*tmschema.h*
, but in more recent
versions of the Windows Development Kit this is
*vssym32.h*
.
...
(n). This uses the WINDOW part WP_SMALLCLOSEBUTTON
...
Change the appearance of a **[ttk::checkbutton](ttk_checkbutton.md)**(n) to use the Explorer pin part EBP_HEADERPIN.
