...
the
**console**
 command.  The behaviour of the console window is
defined mainly through the contents of the
*console.tcl*
 file in
...
and stdin is
**/dev/null**
 (as is the case e.g. when a bundled application
embedding Tk is started by the macOS Launcher).  To enable the command
in that case, define the environment variable
**TK_CONSOLE**
.  This can be
...
equivalent to using the **[wm title](wm.md)** command in the console
interpreter.
...
The
**consoleinterp**
 command in the console interpreter allows
...
*These are documented here for completeness only; they form part of
the internal implementation of the console and are likely to change or
be modified without warning.*
...
- Pressing the return key causes the current line (if complete by the rules of **[info complete](../TclCmd/info.md)**) to be passed to the main interpreter for evaluation.
...
**[destroy](destroy.md)**
,
**[fconfigure](../TclCmd/fconfigure.md)**
,
**[history](../TclCmd/history.md)**
,
