...
**[-padding, padding, Padding](ttk_widget.md#M-padding)**
**[-style, style, Style](ttk_widget.md#M-style)**
**[-takefocus, takeFocus, TakeFocus](ttk_widget.md#M-takefocus)**
**[-xscrollcommand, xScrollCommand, ScrollCommand](ttk_widget.md#M-xscrollcommand)**
**[-yscrollcommand, yScrollCommand, ScrollCommand](ttk_widget.md#M-yscrollcommand)**
...
The treeview widget also supports the following generic **[ttk::widget](ttk_widget.md)** widget subcommands (see *ttk::widget(n)* for details):
...
Database Name: **[image](image.md)**
Database Class: **[Image](image.md)**
...
The **[focus](focus.md)** and **[selection](selection.md)** widget commands can be used to determine the affected item or items.
...
**Treeview**
.
The treeview header class name is
**Heading**
.
The treeview item class name is
**Item**
.
The treeview cell class name is
**Cell**
.

Dynamic states: **disabled**, **selected**.

**Treeview** styling options configurable with **[ttk::style](ttk_style.md)** are:

**-background** *color* **-fieldbackground** *color* **-font** *font* **-foreground** *color* **-indent** *amount*
...
To adjust the **-rowheight** for the Treeview style, use the following code after **[tk scaling](tk.md)** has been applied. Note that even if you do not support or change **[tk scaling](tk.md)** in your program, your users may have it set in their .wishrc.
...
**Heading** styling options configurable with **[ttk::style](ttk_style.md)** are:

**-background** *color* **-font** *font* **-relief** *relief*

**Item** styling options configurable with **[ttk::style](ttk_style.md)** are:

**-foreground** *color* **-indicatormargins** *padding* **-indicatorsize** *amount* **-padding** *padding*

**Cell** styling options configurable with **[ttk::style](ttk_style.md)** are:
