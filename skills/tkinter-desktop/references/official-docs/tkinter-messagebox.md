# tkinter.messagebox（官方文档转档）

> 来源：https://docs.python.org/3/library/tkinter.messagebox.html
...
The `show*` functions and [`Message.show()`](#tkinter.messagebox.Message.show "tkinter.messagebox.Message.show") return the symbolic name of
the button the user pressed, as a string (such as [`OK`](#tkinter.messagebox.OK "tkinter.messagebox.OK") or [`YES`](#tkinter.messagebox.YES "tkinter.messagebox.YES")).
