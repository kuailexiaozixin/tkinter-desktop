# tkinter — Python interface to Tcl/Tk（官方文档转档）
...
[Tk commands](https://www.tcl-lang.org/man/tcl9.0/TkCmd/index.html) reference
...
you’ll find the [`invoke()`](tkinter.ttk.html#tkinter.ttk.Button.invoke "tkinter.ttk.Button.invoke") method on the
...
[ttk::widget](https://www.tcl-lang.org/man/tcl9.0/TkCmd/ttk_widget.html) man
...
[`winfo_x()`](#tkinter.Misc.winfo_x "tkinter.Misc.winfo_x"), [`winfo_height()`](#tkinter.Misc.winfo_height "tkinter.Misc.winfo_height"),
[`winfo_viewable()`](#tkinter.Misc.winfo_viewable "tkinter.Misc.winfo_viewable").
...
methods in the base [`Widget`](#tkinter.Widget "tkinter.Widget") class that all Tkinter widgets
inherit from).
...
:   The `Wm` mixin provides access to the window manager, allowing an
    ...
    :   Register *func* as the handler for the window manager protocol *name*, an
        ...
        [`wm_protocol()`](#tkinter.Wm.wm_protocol "tkinter.Wm.wm_protocol") is an alias of `protocol()`.
