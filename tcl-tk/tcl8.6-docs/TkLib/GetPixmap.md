...
Drawable **d** (in)     Pixmap or window where the new pixmap will be used for
drawing.
...
future. It is important for Tk applications to use these procedures rather than
**XCreatePixmap** and **XFreePixmap** ; otherwise long-running applications may
run out of resource identifiers.
...
[pixmap](../Keywords/P.htm#pixmap), [resource
identifier](../Keywords/R.htm#resource identifier)
