...
**[bind](bind.md)**
 command, it is
associated either with a particular window such as
**.a.b.c**
,
...
See the
**[bind](bind.md)**
 command for more information on the matching
process.
...
first, following by bindings for
**.b**
's toplevel
(“.”),
followed by class bindings, followed by bindings for
**.b**
.
If
*tagList*
 is an empty list then the binding tags for
*window*
...
associated with the
**[Button](button.md)**
 tag, will no longer apply to
**.b**
,
but any bindings associated with
**TrickyButton**
 (perhaps some
...
If you have a set of nested
**[frame](frame.md)**
 widgets and you want events
sent to a
**[button](button.md)**
 widget to also be delivered to all the widgets
up to the current
**[toplevel](toplevel.md)**
 (in contrast to Tk's default
