...
The
**image**
 command is used to create, delete, and query images.
...
the types currently defined (e.g., **[bitmap](bitmap.md)**).
*name* specifies the name for the image;  if it is omitted then
Tk picks a name of the form **image***x*, where *x* is
an integer.
