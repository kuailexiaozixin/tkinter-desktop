...
,
**[grid](grid.md)**
, or other geometry managers
are used to manage the children of the
**[frame](frame.md)**
,
...
**[pack propagate](pack.md)**
 and
**[grid propagate](grid.md)**
 can be used
to change this.
...
**TFrame** styling options configurable with **[ttk::style](ttk_style.md)** are:

**-background** *color* **-relief** *relief*
...
When a new
**ttk::frame**
 is created, it has no default event bindings;

**ttk::frame**
s are not intended to be interactive.
