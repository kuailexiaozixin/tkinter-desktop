...
*pathName*
 argument) and makes it into a labelframe widget.
Additional
...
A labelframe is a simple widget. Its primary purpose is to act as a spacer or container for complex window layouts. It has the features of a **[frame](frame.md)** plus the ability to display a label.
...
*PathName*
 is the name of the command, which is the same as
the labelframe widget's path name.
*Option*
 and the
*arg*
s
...
**labelframe**
 widgets are used to organize the available choices by
