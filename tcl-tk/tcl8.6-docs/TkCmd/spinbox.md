...
**[-repeatdelay, repeatDelay, RepeatDelay](options.md#M-repeatdelay)**
**[-repeatinterval, repeatInterval, RepeatInterval](options.md#M-repeatinterval)**
...
Database Name: **[format](../TclCmd/format.md)**
Database Class: **[Format](../TclCmd/format.md)**
...
**[focus](focus.md)**, **focusin**, **focusout**, **key**, or **all**.
...
*pathName*
 argument) and makes it into a spinbox widget.
...
option to a script which will be evaluated according to the
**-validate**
...
It is possible to perform percent substitutions on the **-validatecommand** and **-invalidcommand** scripts, just as you would in a **[bind](bind.md)** script. The following substitutions are recognized:
...
will in fact set the
**-validate**
 option to
**none**
 because the default
value for the spinbox gets changed (due to the
**-from**
 and
**-to**
...
**none**, **buttondown**, **buttonup**, **[entry](entry.md)**.
