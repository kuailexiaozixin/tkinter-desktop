...
of the
**[ttk::entry](ttk_entry.md)**
 widget including support of the

**-textvariable**
 option to link the value displayed by the widget
to a Tcl variable.
...
**[-validate, validate, Validate](ttk_entry.md#M-validate)**
**[-validatecommand, validateCommand, ValidateCommand](ttk_entry.md#M-validatecommand)**
...
See the
**[ttk::entry](ttk_entry.md)**
 manual for information about using the
...
Dynamic states: **active**, **disabled**, **[focus](focus.md)**, **readonly**.

**TSpinbox** styling options configurable with **[ttk::style](ttk_style.md)** are:

**-arrowcolor** *color* **-arrowsize** *amount* **-background** *color*
