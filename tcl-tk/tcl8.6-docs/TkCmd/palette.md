...
The
**tk_setPalette**
 procedure changes the color scheme for Tk.
...
Alternatively, the arguments to
**tk_setPalette**
...
-
*value*
 pairs, where the first argument of the pair
...
**tk_setPalette**
 tries to compute reasonable defaults for any
