...
The
**tk**
 command provides access to miscellaneous
...
of the application (the name that may be used in **[send](send.md)**
...
If sends have been disabled by deleting the **[send](send.md)** command,
this command will reenable them and recreate the **[send](send.md)**
command.
**tk busy***subcommand* ...
...
more details see the **[busy](busy.md)** manual page.
...
**[fontchooser](fontchooser.md)** manual page.
