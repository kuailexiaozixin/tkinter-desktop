...
a hexadecimal string like the ones returned by the **[winfo id](winfo.md)**
...
The
**toplevel**
 command creates a new toplevel widget (given
by the
*pathName*
 argument).  Additional
