...
Database Class: **[Variable](../TclCmd/variable.md)**
...
*pathName*
 argument) and makes it into a listbox widget.
Additional
...
**[selection anchor](selection.md)** widget command.
**end**
...
to delete.  If *last* is not specified it defaults to
...
by its
**-selectmode**
 option, which selects one of four ways
