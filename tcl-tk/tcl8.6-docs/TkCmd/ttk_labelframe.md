...
A
**ttk::labelframe**
 widget is a container used to group other widgets
...
The **-labelwidget** must be a child of the **[labelframe](labelframe.md)** widget
or one of the **[labelframe](labelframe.md)**'s ancestors, and must belong to the
same top-level widget as the **[labelframe](labelframe.md)**.
...
**TLabelframe** styling options configurable with **[ttk::style](ttk_style.md)** are:

**-background** *color* **-bordercolor** *color* **-borderwidth** *amount* **-darkcolor** *color* **-labelmargins** *amount* **-labeloutside** *boolean* **-lightcolor** *color* **-relief** *relief*

**TLabelframe.Label** styling options configurable with **[ttk::style](ttk_style.md)** are:

**-background** *color* **-font** *font* **-foreground** *color*
