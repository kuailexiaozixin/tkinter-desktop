...
The rest of the list is a sequence of
*statespec / value*
...
the image will be placed in the parcel based on the
**-sticky**
 option.
If the image needs to stretch horizontally (i.e.,
**-sticky ew**
)
or vertically (
**-sticky ns**
...
The
**-border**
 divides the image into 9 regions:
