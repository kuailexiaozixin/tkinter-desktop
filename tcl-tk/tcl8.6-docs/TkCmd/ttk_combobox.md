...
(in addition to integers, the **end** index is supported and indicates
...
The combobox widget also supports the following **[ttk::entry](ttk_entry.md)** widget subcommands (see *ttk::entry(n)* for details):
...
The combobox widget also supports the following generic
**[ttk::widget](ttk_widget.md)**

widget subcommands (see
*ttk::widget(n)*
 for details):
...
The combobox widget generates a
**<<ComboboxSelected>>**
 virtual event
...
**[listbox](listbox.md)**
 widgets internally.
The listbox frame has a class name of
**ComboboxPopdownFrame**
.

Dynamic states: **disabled**, **[focus](focus.md)**, **pressed**, **readonly**.

**TCombobox** styling options configurable with **[ttk::style](ttk_style.md)** are:

**-arrowcolor** *color* **-arrowsize** *amount* **-background** *color* **-bordercolor** *color* **-darkcolor** *color* **-focusfill** *color* **-foreground** *color* **-fieldbackground** *color*
...
The **ttk::combobox** popdown listbox cannot be configured using **[ttk::style](ttk_style.md)** nor via the widget **configure** command. The listbox can be configured using the option database.
...
**ComboboxPopdownFrame** styling options configurable with **[ttk::style](ttk_style.md)** are:

**-borderwidth** *amount* **-relief** *relief*
