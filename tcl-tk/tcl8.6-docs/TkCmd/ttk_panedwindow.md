...
A
**ttk::panedwindow**
 widget displays a number of subwindows,
...
If *component* is omitted, it defaults to **sash**.
...
If *newpos* is specified, sets the position
of sash number *index*.
...
The panedwindow widget also supports the following generic **[ttk::widget](ttk_widget.md)** widget subcommands (see *ttk::widget(n)* for details):
...
**TPanedwindow**
.  The
sash has a class name of
**Sash**
.

**TPanedwindow** styling options configurable with **[ttk::style](ttk_style.md)** are:

**-background** *color*

**Sash** styling options configurable with **[ttk::style](ttk_style.md)** are:

**-background** *color* **-bordercolor** *color* **-gripcount** *count* **-handlepad** *amount* **-handlesize** *amount* **-lightcolor** *color* **-sashpad** *amount* **-sashrelief** *relief* **-sashthickness** *amount*
