...
Note that *offset* values are byte offsets, not character offsets. Both **seek** and **[tell](tell.md)** operate in terms of bytes, not characters, unlike **[read](read.md)**.
