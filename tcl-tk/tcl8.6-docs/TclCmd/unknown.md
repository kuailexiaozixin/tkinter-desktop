...
of
**unknown**
 is a library procedure defined when Tcl initializes an
interpreter.  You can override the default
**unknown**
 to change its
functionality, or you can register a new handler for individual namespaces
using the
**[namespace unknown](namespace.md)**
 command.  Note that there is no default
implementation of
**unknown**
