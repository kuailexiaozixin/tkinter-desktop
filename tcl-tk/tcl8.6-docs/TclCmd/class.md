...
if present, is sent to the
**[oo::define](define.md)**
 command (along with the name of
...
The
**oo::class**
 class does not define an explicit destructor. However,
...
internal namespace will be *nsName*;
