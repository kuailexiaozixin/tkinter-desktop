...
The
*option*
 argument determines what action is carried
out by the command.
The legal
*options*
...
**[string match](string.md)**) are included.
...
defaults to **-glob**.  See the documentation for **[string match](string.md)**
for information on glob style matching, and the documentation for
**[regexp](regexp.md)** for information on regexp matching.
...
get** or **array names**, together with **[foreach](foreach.md)**, to iterate
...
matching rules of **[string match](string.md)**).  If *arrayName* is not the name
