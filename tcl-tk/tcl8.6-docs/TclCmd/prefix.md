...
on the **-error** option. (It is recommended that the *table* be sorted
...
*options* are used as **[return](return.md)** options when generating the error
message. The default corresponds to setting
“-level 0”.
Example: If
“**-error** {-errorcode MyError -level 1}”
...
Creating a **[switch](switch.md)** that supports prefixes:
