...
The
**[expr](expr.md)**
 command handles mathematical functions of the form

**sin($x)**
 or
**atan2($y,$x)**
 by converting them to calls of the
form
**[tcl::mathfunc::sin [expr {$x}]]**
 or
...
for code apart from
**[expr](expr.md)**
, by invoking the given commands
directly.
...
element of the **[tcl_platform](tclvars.md)** array.
**isqrt***arg*
...
Copyright © 2005, 2006 Kevin B. Kenny <
[email protected]
>.
