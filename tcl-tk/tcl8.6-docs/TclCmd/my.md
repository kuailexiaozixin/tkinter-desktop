...
The
**my**
 command is used to allow methods of objects to invoke any method
of the object (or its class). In particular, the set of valid values for

*methodName*
 is the set of all methods supported by an object and its
...
(i.e. the object that is returned by
**[self object](self.md)**
) from which the
...
the
**[oo::object](object.md)**
 class, which is not publicly visible by default:
