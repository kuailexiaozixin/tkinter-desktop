...
all of
*string*
 and returns 1 if it does, 0 if it does not, unless
...
**-indices**
Changes what is stored in the *matchVar* and *subMatchVar*s.
...
**foo**
 in a
string that is not actually an instance of
**foobar**
, and get the
...
This lists all words (consisting of all sequences of non-whitespace characters) in a string, and is useful as a more powerful version of the **[split](split.md)** command:
